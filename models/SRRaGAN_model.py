...
print("####################################################")
print("hey foooooooooooooooooooooocus on me")
print("####################################################")
...
class SRRaGANModel(BaseModel):
    ...
    def print_network(self):
        ...
        if self.is_train:
            ...
            if isinstance(self.netD, nn.parallel.DistributedDataParallel):
            ...
            if self.cri_fea:  # F, Perceptual Network
                ...
                if isinstance(self.netF, nn.parallel.DistributedDataParallel):
